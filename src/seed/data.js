...
const DATA = [
  ...
  },
  {
    ...
    refString: {
      first: `F: ${signs.lessThan.sign}32 ${units.U_SLASH_L}`,
      second: `H: ${signs.lessThan.sign}49 ${units.U_SLASH_L}`,
    },
    result: [{ id: uuidv4(), type: undefined, value: units.U_SLASH_L }], // no value asssigned yet
  },
  {
  ...
  },
  {
    ...
    refString: {
      first: `H: (16 ${signs.range.sign} 220) ${units.NG_SLASH_ML}`,
      second: `F: (10 ${signs.range.sign} 125) ${units.NG_SLASH_ML}`,
    },
  ...
  {
    id: uuidv4(),
    paperType: paperTypes.DOUBLE_UNIT_TEST,
    refSign: signs.range.name,
    category: categories.BIOCHIMIE,
    name: "Glycémie",
    ...
    refString: {
      first: `(4.1 - 6.1) ${units.MMOL_SLASH_L}`,
      second: `(0.7 - 1.1) ${units.G_SLASH_L}`,
    },
    result: [
...

  {
    ...
    refString: {
      first: `Négatif: ${signs.lessThan.sign} 1 ${units.MIU_SLASH_ML} `,
      second: `Positif: ${signs.greaterThanEqual.sign} 1 ${units.MIU_SLASH_ML}`,
    },
    result: [
      {
        id: uuidv4(),
  ...
  {
    id: uuidv4(),
    paperType: paperTypes.WIDAL_TEST,
    refSign: signs.none.name,
    category: categories.SEROLOGIE_IMMUNOLOGIE,
    name: "Widal",
    unit: units.NONE,
...

  {
    ...
    ref: { lower: 1, higher: 1 },
    refString: {
      first: `Négatif: ${signs.lessThan.sign} 1 ${units.INDEX_SLASH_ML} `,
      second: `Positif: ${signs.greaterThanEqual.sign} 1 ${units.INDEX_SLASH_ML}`,
    },
    result: [
      {
        id: uuidv4(),
...

  {
    ...
    refString: {
      first: `Négatif: ${signs.lessThan.sign} 20 ${units.AU_SLASH_ML}`,
      second: `Positif: ${signs.greaterThanEqual.sign} 20 ${units.AU_SLASH_ML}`,
    },
    result: [
      {
        id: uuidv4(),
...

  {
    ...
    refString: {
      first: `Négatif: ${signs.lessThan.sign} 15 ${units.INDEX_SLASH_ML}`,
      second: `Positif: ${signs.greaterThanEqual.sign} 15 ${units.INDEX_SLASH_ML}`,
    },
    result: [
      {
        id: uuidv4(),
...

  {
    ...
    refString: {
      first: `Négatif: ${signs.lessThan.sign} 100 ${units.INDEX_SLASH_ML}`,
      second: `Positif: ${signs.greaterThanEqual.sign} 100 ${units.INDEX_SLASH_ML}`,
    },
    result: [
      {
        id: uuidv4(),
...

  {
    ...
    refString: {
      first: `Négatif: ${signs.lessThan.sign} 10 ${units.MIU_SLASH_ML} `,
      second: `Positif: ${signs.greaterThanEqual.sign} 10 ${units.MIU_SLASH_ML}`,
    },
    result: [
      {
        id: uuidv4(),
...

  {
    ...
    refString: {
      first: `1 ${signs.range.sign} 14 ans: (0.80 ${signs.range.sign} 1.73)`,
      second: `${signs.greaterThan.sign} 14 ans: (0.82 ${signs.range.sign} 1.93)`,
    },
    result: [
      {
        id: uuidv4(),
